export const userData = {
  personal: {
    ...
    email: "inayansingh@gmail.com", // Updated as requested
    linkedin: "https://www.linkedin.com/in/nayansinghanalytics/",
    about: "Data professional with extensive experience in analytics, data engineering, and visualization. Proven ability to build scalable data solutions, manage cross-functional teams, and derive cohesive insights for top global brands.",
  },
  skills: {
    languages: ["Python", "SQL", "JavaScript", "HTML", "CSS"],
    cloudAndDB: ["Google Cloud Platform (GCP)", "AWS S3", "Google BigQuery", "AWS Redshift", "SQL Server"],
    tools: ["Tableau", "Looker / Google Data Studio", "Alteryx", "Power BI", "Adobe Analytics", "Google Analytics"],
    marketing: ["Google Ads", "Bing Ads", "Facebook Ads", "DoubleClick", "TradeDesk", "SEMRush", "BrightEdge"]
  },
  experience: [
    {
